...
# directories. Shared by the pilot-readiness gate and (when enabled) the CI
# workflows so the two can never drift apart. Scans tracked files only (via git grep),
